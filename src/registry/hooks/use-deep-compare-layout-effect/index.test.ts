...
describe('useDeepCompareLayoutEffect', () => {
  it('should run effect on mount', () => {
    ...
    renderHook(() => useDeepCompareLayoutEffect(mockEffect, []))
  ...
  it('should not run effect when dependencies are shallowly equal', () => {
    ...
    const { rerender } = renderHook(
      ({ deps }) => useDeepCompareLayoutEffect(mockEffect, deps),
      { initialProps: { deps } },
    )
  ...
  it('should run cleanup function', () => {
    ...
    const { unmount } = renderHook(() =>
      useDeepCompareLayoutEffect(mockEffect, []),
    )
  ...
  it('should handle undefined dependencies', () => {
    ...
    expect(() => {
      renderHook(() => useDeepCompareLayoutEffect(mockEffect, undefined as any))
    }).not.toThrow()
